...
using UnityEngine;
using System.Linq;
using ShadowBox.Types;

namespace ShadowBox.Extensions
{
	public static class ShadowedCollections
	{
		/// <summary>
		...
		/// <summary>
		/// Is Keys in ShadowedDictionary is the same as some collection
		/// </summary>
		public static bool ContentsMatchKeys<T1, T2>(this ShadowedDictionary<T1, T2> source, IEnumerable<T1> check)
		{
		...
		/// <summary>
		/// Is Values in ShadowedDictionary is the same as some collection
		/// </summary>
		public static bool ContentsMatchValues<T1, T2>(this ShadowedDictionary<T1, T2> source, IEnumerable<T2> check)
		{
			if (source.IsNullOrEmpty() && check.IsNullOrEmpty()) return true;
			if (source.IsNullOrEmpty() || check.IsNullOrEmpty()) return false;
