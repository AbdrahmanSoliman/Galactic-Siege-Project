using static ShadowBox.Extensions.ShadowedColor;
...
{
    public static class ShadowedDebug
	{
		#region Log Array
		...
		{
			module = $"[{module}]";
			Debug.Log($"{module.Colored(ShadowedPurple).Bold()}: {message}");
			//Debug.Log($"{module.Colored(ShadowedPurple).Bold()}]: {message}");
        }

		public static void Log(string module, string message, UnityEngine.Object Object = null)
        {
			module = $"[{module}]";
			if (Object != null)
				Debug.Log($"{module.Colored(ShadowedPurple).Bold()}: {message}", Object);
			else
				Debug.Log($"{module.Colored(ShadowedPurple).Bold()}: {message}");
		...
		{
			module = $"[{module}]";
			Debug.LogWarning($"{module.Colored(ShadowedPurple).Bold()}: {message}");
		}

		public static void LogWarning(string module, string message, UnityEngine.Object Object)
		{
			module = $"[{module}]";
			Debug.LogWarning($"{module.Colored(ShadowedPurple).Bold()}: {message}", Object);
		}
		public static void LogError(string module, string message)
		{
			Debug.LogError($"<b><color=red>[{module}]</color></b>: {message}");
		}

		public static void LogError(string module, string message, UnityEngine.Object Object)
		{
			Debug.LogError($"<b><color=red>[{module}]</color></b>: {message}", Object);
		}
		#endregion
