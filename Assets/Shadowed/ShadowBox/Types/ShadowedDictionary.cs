...
namespace ShadowBox.Types
{
	...
	public class ShadowedDictionary<TKey, TValue> : IDictionary<TKey, TValue>
	{
		...
		public ShadowedDictionary() : this(0, null)
		{
		}

		public ShadowedDictionary(int capacity) : this(capacity, null)
		{
		}

		public ShadowedDictionary(IEqualityComparer<TKey> comparer) : this(0, comparer)
		{
		}
		...
		public ShadowedDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, null)
		{
		}
        ...
        bool IsNull(object obj)
		{
			...
			ShadowedDictionary<TKey, TValue> v = (ShadowedDictionary<TKey, TValue>)obj;
			return v == null;
		}
		public new bool ReferenceEquals(object a, object b)
		{
		...
		public override bool Equals(object obj)
		{
			...
			if (!(obj is Dictionary<TKey, TValue>) || !(obj is ShadowedDictionary<TKey, TValue>)) return false;

			if ((obj is Dictionary<TKey, TValue>))
			{
				Dictionary<TKey, TValue> s = (Dictionary<TKey, TValue>)obj;
				return this == s;
			}
			else if ((obj is ShadowedDictionary<TKey, TValue>))
			{
				var s = (ShadowedDictionary<TKey, TValue>)obj;
				return this == s;
			}
			return false;
		}

		public static bool operator ==(ShadowedDictionary<TKey, TValue> a, IDictionary<TKey, TValue> b) => a == b;
		public static bool operator !=(ShadowedDictionary<TKey, TValue> a, IDictionary<TKey, TValue> b) => a != b;
		public static bool operator ==(Dictionary<TKey, TValue> a, ShadowedDictionary<TKey, TValue> b) => a == b;
		public static bool operator !=(Dictionary<TKey, TValue> a, ShadowedDictionary<TKey, TValue> b) => a != b;
		...
		{
			private readonly ShadowedDictionary<TKey, TValue> _dictionary;
			private readonly int _Version;
			private int _index;

			public KeyValuePair<TKey, TValue> Current { get; private set; }

			internal Enumerator(ShadowedDictionary<TKey, TValue> dictionary) : this()
			{
